<template>
    <div id="app" class="container-fluid">
      <div class="content">
        ...
        <div v-else class="card addCard" style="width: 30rem;">
          <div class="card-body">
            <div class="cardTitle">
              <h5 class="card-title">{{ isEditing ? 'Edit Product' : 'Add Product' }} &#129365&#127815&#127838&#129367;</h5>
  ...
  import { getFirestore, collection, getDocs, addDoc, deleteDoc, doc, updateDoc } from "https://www.gstatic.com/firebasejs/9.10.0/firebase-firestore.js";
  
  // Firebase configuration
  const firebaseConfig = {
    apiKey: "AIzaSyCDgIfJVx5XgguXrsJS0JgHYEwqd17zCNs",
    authDomain: "wad2-c6543.firebaseapp.com",
    projectId: "wad2-c6543",
    storageBucket: "wad2-c6543.appspot.com",
    messagingSenderId: "167804855855",
    appId: "1:167804855855:web:e0ab5f7a50b333d7ce48da",
  };
